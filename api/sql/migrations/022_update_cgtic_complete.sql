-- ===================================================================
-- MIGRAÇÃO: ATUALIZAÇÃO COMPLETA DO COMITÊ CGTIC
...
IF v_comite_id IS NULL THEN
  RAISE EXCEPTION 'Comitê CGTIC não encontrado. Verifique a tabela comites.';
END IF;
...
SELECT COUNT(*) INTO v_count_old_reunioes 
FROM comite_reunioes 
WHERE comite_id = v_comite_id;

SELECT COUNT(*) INTO v_count_old_pauta
FROM comite_reuniao_pauta p
JOIN comite_reunioes r ON r.id = p.reuniao_id
WHERE r.comite_id = v_comite_id;

RAISE NOTICE 'Dados antigos encontrados:';
RAISE NOTICE '  - Reuniões: %', v_count_old_reunioes;
RAISE NOTICE '  - Itens de pauta: %', v_count_old_pauta;

-- DELETAR dados antigos (cascata)
RAISE NOTICE 'Removendo dados antigos...';

DELETE FROM comite_reuniao_pauta 
WHERE reuniao_id IN (
  SELECT id FROM comite_reunioes WHERE comite_id = v_comite_id
);

DELETE FROM comite_reunioes WHERE comite_id = v_comite_id;

RAISE NOTICE '✓ Dados antigos removidos com sucesso!';
RAISE NOTICE '';

-- ===================================================================
-- ETAPA 2: INSERIR NOVOS DADOS
-- ===================================================================

RAISE NOTICE 'Inserindo novos dados...';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 1, 2025, '2025-02-14', 'fevereiro', 'Realizada', 'Reunião 1 - 2025',
...
RAISE NOTICE 'Reunião 1 inserida - 5 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 2, 2025, '2025-02-28', 'fevereiro', 'Realizada', 'Reunião 2 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 2 inserida - 7 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 3, 2025, '2025-03-14', 'março', 'Realizada', 'Reunião 3 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 3 inserida - 11 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 4, 2025, '2025-03-31', 'março', 'Realizada', 'Reunião 4 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 4 inserida - 5 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 5, 2025, '2025-04-14', 'abril', 'Realizada', 'Reunião 5 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 5 inserida - 4 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 6, 2025, '2025-04-28', 'abril', 'Realizada', 'Reunião 6 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 6 inserida - 2 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 7, 2025, '2025-05-12', 'maio', 'Realizada', 'Reunião 7 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 7 inserida - 3 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 8, 2025, '2025-05-26', 'maio', 'Realizada', 'Reunião 8 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 8 inserida - 6 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 9, 2025, '2025-06-09', 'junho', 'Realizada', 'Reunião 9 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 9 inserida - 5 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 10, 2025, '2025-06-24', 'junho', 'Realizada', 'Reunião 10 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 10 inserida - 3 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 11, 2025, '2025-07-14', 'julho', 'Realizada', 'Reunião 11 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
...
RAISE NOTICE 'Reunião 11 inserida - 2 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 12, 2025, '2025-07-28', 'julho', 'Realizada', 'Reunião 12 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_12_id;
...
RAISE NOTICE 'Reunião 12 inserida - 3 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 13, 2025, '2025-08-11', 'agosto', 'Realizada', 'Reunião 13 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_13_id;
...
RAISE NOTICE 'Reunião 13 inserida - 3 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 14, 2025, '2025-08-25', 'agosto', 'Realizada', 'Reunião 14 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_14_id;

INSERT INTO comite_reuniao_pauta (reuniao_id, numero_item, descricao, ordem) VALUES
(v_reuniao_14_id, 1, 'Reestruturação DTI', 1);

RAISE NOTICE 'Reunião 14 inserida - 1 item de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 15, 2025, '2025-09-08', 'setembro', 'Realizada', 'Reunião 15 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_15_id;
...
RAISE NOTICE 'Reunião 15 inserida - 4 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 16, 2025, '2025-09-22', 'setembro', 'Realizada', 'Reunião 16 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_16_id;

INSERT INTO comite_reuniao_pauta (reuniao_id, numero_item, descricao, ordem) VALUES
(v_reuniao_16_id, 1, '202505000637323 - IGovTIC-JUD 2025.', 1);

RAISE NOTICE 'Reunião 16 inserida - 1 item de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 17, 2025, '2025-10-06', 'outubro', 'Realizada', 'Reunião 17 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_17_id;
...
RAISE NOTICE 'Reunião 17 inserida - 2 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 18, 2025, '2025-10-20', 'outubro', 'Realizada', 'Reunião 18 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_18_id;
...
RAISE NOTICE 'Reunião 18 inserida - 2 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 19, 2025, '2025-11-12', 'novembro', 'Realizada', 'Reunião 19 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_19_id;
...
RAISE NOTICE 'Reunião 19 inserida - 4 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 20, 2025, '2025-11-24', 'novembro', 'Realizada', 'Reunião 20 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_20_id;
...
RAISE NOTICE 'Reunião 20 inserida - 2 itens de pauta';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 21, 2025, '2025-12-09', 'dezembro', 'Realizada', 'Reunião 21 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-gestor-de-tecnologia-da-informacao-e-comunicacao-cgtic',
  'Reuniões Quinzenais',
  NOW(), NOW()
) RETURNING id INTO v_reuniao_21_id;
...
RAISE NOTICE 'Reunião 21 inserida - 3 itens de pauta';
...
RAISE NOTICE '===================================================================';
RAISE NOTICE 'Comitê: CGTIC (ID: %)', v_comite_id;
RAISE NOTICE 'Novas reuniões inseridas: 21';
RAISE NOTICE 'Novos itens de pauta inseridos: 88';
RAISE NOTICE '===================================================================';
