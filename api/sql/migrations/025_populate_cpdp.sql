...
IF v_comite_id IS NULL THEN
  RAISE EXCEPTION 'Comitê CPDP não encontrado. Verifique se o comitê foi criado na tabela comites.';
END IF;

RAISE NOTICE '===================================================================';
RAISE NOTICE 'Iniciando população do comitê CPDP (ID: %)', v_comite_id;
RAISE NOTICE '===================================================================';
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 1, 2025, '2025-03-21', 'março', 'Realizada', 'Reunião 1 - 2025',
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 2, 2025, '2025-04-24', 'abril', 'Realizada', 'Reunião 2 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 3, 2025, '2025-05-19', 'maio', 'Realizada', 'Reunião Extraordinária 3 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 4, 2025, '2025-06-24', 'junho', 'Realizada', 'Reunião 4 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
IF v_reuniao_4_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 4 inserida - 9 itens de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 5, 2025, '2025-07-24', 'julho', 'Realizada', 'Reunião Extraordinária 5 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião Extraordinária',
  NOW(), NOW()
...
IF v_reuniao_5_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 5 (Extraordinária) inserida - 1 item de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 6, 2025, '2025-08-26', 'agosto', 'Realizada', 'Reunião 6 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
IF v_reuniao_6_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 6 inserida - 4 itens de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 7, 2025, '2025-09-25', 'setembro', 'Realizada', 'Reunião 7 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
IF v_reuniao_7_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 7 inserida - 8 itens de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 8, 2025, '2025-10-10', 'outubro', 'Realizada', 'Reunião Extraordinária 8 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião Extraordinária',
  NOW(), NOW()
...
IF v_reuniao_8_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 8 (Extraordinária) inserida - 1 item de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 9, 2025, '2025-10-21', 'outubro', 'Realizada', 'Reunião 9 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
IF v_reuniao_9_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 9 inserida - 1 item de pauta';
END IF;
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 10, 2025, '2025-11-24', 'novembro', 'Realizada', 'Reunião 10 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Reunião ordinária',
  NOW(), NOW()
...
INSERT INTO comite_reunioes (
  ...
  v_comite_id, 11, 2025, '2025-12-16', 'dezembro', 'Realizada', 'Reunião 11 - 2025',
  'https://portaltj.tjgo.jus.br/sistemas/index.php?s=corporativo&mensagem=ausencia_cookies_proad',
  'https://www.tjgo.jus.br/index.php/comissoes-comites/comites/comite-de-protecao-de-dados-pessoais',
  'Última reunião ordinária de 2025',
  NOW(), NOW()
)
ON CONFLICT (comite_id, numero, ano) DO NOTHING
...
IF v_reuniao_11_id IS NOT NULL THEN
  ...
  ON CONFLICT (reuniao_id, numero_item) DO NOTHING;
  RAISE NOTICE 'Reunião 11 inserida - 8 itens de pauta';
END IF;
...
RAISE NOTICE '===================================================================';
RAISE NOTICE 'Comitê: CPDP (ID: %)', v_comite_id;
RAISE NOTICE 'Reuniões inseridas: 11 (8 ordinárias + 3 extraordinárias)';
